...
template <class TVal>
void FastFFT<TVal>::Butterfly2(const Complex<TVal>* inp, Complex<TVal>* outp, const int len)
{
...
template <class TVal>
void FastFFT<TVal>::Butterfly4(const Complex<TVal>* inp, Complex<TVal>* outp, const int len)
{
...
template <class TVal>
void FastFFT<TVal>::Butterfly8(const Complex<TVal>* inp, Complex<TVal>* outp, const int len)
{
...
template <class TVal>
void FastFFT<TVal>::Butterfly(const Complex<TVal>* inp, Complex<TVal>* outp, const int stageSize, const int len)
{
