...
template <class TVal>
__alwaysinline void Complex<TVal>::Multiply(Complex<TVal>& dest, const Complex<TVal>& c1, const Complex<TVal>& c2)
{
...
template <class TVal>
__alwaysinline void Complex<TVal>::Add(Complex& dest, const Complex& c1, const Complex& c2)
{
...
template <class TVal>
__alwaysinline void Complex<TVal>::Subtract(Complex& dest, const Complex& c1, const Complex& c2)
{
	dest.Real = c1.Real - c2.Real;
	dest.Imag = c1.Imag - c2.Imag;
}
...
template <class TVal>
__alwaysinline void Complex<TVal>::Multiply(Complex<TVal>& dest, const Complex<TVal>& c1)
{
...
template <class TVal>
__alwaysinline void Complex<TVal>::Add(Complex& dest, const Complex& c1)
{
	dest.Real += c1.Real;
	dest.Imag += c1.Imag;
}
...
template <class TVal>
__alwaysinline void Complex<TVal>::Subtract(Complex& dest, const Complex& c1)
{
	dest.Real -= c1.Real;
	dest.Imag -= c1.Imag;
}
